...
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
\section{Compute more plotpoints (sample)}
%+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\begin{description}
    ...
    \item[Force smoothing]
        ...
        In this case, the \( 100\) interpolation points will be taken regularly spaced with respect to the \emph{arc length}. This is more precise, but this functionality make a quite intensive\footnote{And not optimised at all} use of numerical integrals in order to find the interpolation points.

        Notice that the result is not always better.
\end{description}
...
Let us see the results that we compare with figure \ref{LabelFigLARGooSLxQTdPC}. 

\begin{center}
   \input{Fig_PBFCooVlPiRBpt.pstricks}
\end{center}
The result is far from being better because in the angles, both the sine and the cosine are at their maximum and have then a small derivative. Thus the curve is slow at these places and an linearly spaces \emph{parameter} computation creates more points there.
