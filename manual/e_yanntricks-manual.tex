...
% This is the skeleton of my document containing all the pictures
...
\usepackage{calc}   % Les dépendances de yanntricks si on n'utilise que le pdf.
\usepackage{tikz}
\usetikzlibrary{patterns}
\usetikzlibrary{calc}

% Some  'configuration' for tikz       
\newcounter{defHatch}
...
\newcommand{\yanntricks}{\texttt{yanntricks}} 
