...
def OMPAooMbyOIqeA():
    ...
    pspicts.append(create_example(angleI=90,angleF=110,text="\( mMó\)",name="14",dist=0.7))
    ...
    pspicts.append(create_example(angleI=160,angleF=223,text="\( \int_A40mmmm\)",name="Six",dist=1.2))
    pspicts.append(create_example(angleI=180,angleF=250,text="\(who\)",name="Seven",dist=None))
    pspicts.append(create_example(angleI=200,angleF=270,text="\(70^oo\)",name="Eight",dist=None))
    ...
    pspicts.append(create_example(angleI=290,angleF=331,text="ÈÉç",name="Twelve",dist=None))
