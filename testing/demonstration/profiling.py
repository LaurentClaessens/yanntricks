...
def profile_me():
    ...
    return "ok"
    cProfile.run("exCircleThree()")
    cProfile.run("exCircleTwo()")
    cProfile.run("OnePoint()")
    cProfile.run("FunctionFirst()")
    cProfile.run("FunctionFive()")
    cProfile.run("FunctionFour()")
    cProfile.run("FunctionSecond()")
    cProfile.run("GestionRepere()")
    cProfile.run("GridOne()")
    cProfile.run("GridThree()")
    cProfile.run("GridTwo()")
    cProfile.run("Lines()")
    cProfile.run("MarkOnPoint()")
    cProfile.run("ParametricOne()")
    cProfile.run("ParametricTwo()")
    cProfile.run("VectorOne()")
    cProfile.run("TRJEooPRoLnEiG()")
    cProfile.run("QRXCooUmnlhkvh()")
    cProfile.run("UREIooqNGBXtHg()")
    cProfile.run("QIXEooejrojKjo()")
    cProfile.run("DEIToomZFknFmn()")
    cProfile.run("QNHAooSYgkWVhJ()")
    cProfile.run("UARHooLMWqvyaI()")
    cProfile.run("HELQooLGapRQrr()")
    cProfile.run("YJEDoojDtSeKHQ()")
    cProfile.run("QRJOooKZPUoLlF()")
    cProfile.run("RVKFooDxrqYXAX()")
    cProfile.run("PFCUoorQhitKoJ()")
    cProfile.run("EXIIooJzzoJeai()")
    cProfile.run("JSYWooQYduLVLS()")

    cProfile.run("LWVXooPyIlOKNd()")
    cProfile.run("PJKBooOhGVPkeR()")
    cProfile.run("LVPSoozFTyaeCG()")
    cProfile.run("AxesSecond()")
    cProfile.run("YOWDooyeyOJyml()")
    cProfile.run("CUZFooGqZLaAEp()")
